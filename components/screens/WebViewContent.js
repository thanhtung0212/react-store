...
export default class WebViewContent extends React.Component {
  ...
  getContent() {
    ...
    content +=
      '<style>img {max-width: 100%;} body {font-family: arial; font-size: ' +
      fontSize +
      '} td,th {font-size: ' +
      fontSize +
      ' !important, padding: 15px !important} iframe {max-width: 100% !important} </style>';
  ...
  render() {
    return (
      <Wrapper>
        ...
        <WebView
          style={{width: '100%', flex: 1, height: height * 0.85}}
          originWhitelist={['*']}
